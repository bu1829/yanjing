            ...
            if ($row = mysql_fetch_row($rs)) {
                ...
                foreach ($tables as $table) {
                    ...
                    if ($tableRow = mysql_fetch_row($tableRs)) {
                        $this->content .= "/* 创建表结构 {$table} */ \r\n";
                        $this->content .= "DROP TABLE IF EXISTS {$table};/* MySQLReback Separation */ {$tableRow[1]};/* MySQLReback Separation */ \r\n";
                        ...
                        if (is_array($temp)) {
                            foreach ($temp as $v) {
                                ...
                                if ($values != ';/* MySQLReback Separation */') {
                                    $this->content .= "/* 插入数据 {$table} */ \r\n";
                                    $this->content .= "INSERT INTO {$table} VALUES {$values}";
                                }
                            }
                        }
                    }
