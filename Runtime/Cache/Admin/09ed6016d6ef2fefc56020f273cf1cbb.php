...
<body>
									...
									<div class="tab-content">
										...
										<div class="new_user" style="display:show;">
		                                    ...
		                                    <div class="form-group">
		                                        <label class="col-sm-2 control-label"><font class="text-danger">*</font> 客户姓名：</label>
		                                        <div class="col-sm-4">
		                                    ...
		                                    <div class="form-group">
		                                        <label class="col-sm-2 control-label"><font class="text-danger">*</font> 客户年龄：</label>
		                                        <div class="col-sm-4">
		                                            <input  name="age" value="<?php echo ($data["age"]); ?>" class="form-control" type="text" maxlength="255">
		                                        </div>
		                                    </div>

		                                    <div class="form-group">
		                                        <label class="col-sm-2 control-label"><font class="text-danger">*</font> 性别：</label>
		                                        <div class="col-sm-3">
		                                    ...
		                                    <div class="form-group">
		                                        <label class="col-sm-2 control-label"><font class="text-danger">*</font> 客户手机号：</label>
		                                        <div class="col-sm-4">
		                                            <input  name="mobile" value="<?php echo ($data["mobile"]); ?>" class="form-control" type="text" maxlength="255">
		                                        </div>
		                                    </div>

		                                    <div class="form-group">
		                                        <label class="col-sm-2 control-label"><font class="text-danger">*</font> 客户住址：</label>
		                                        <div class="col-sm-4">
		                                            <input  name="address" value="<?php echo ($data["address"]); ?>" class="form-control" type="text" maxlength="255">
		                                        </div>
		                                    </div>
    ...
    $().ready(function(){
    	 $("#sex<?php echo ($data["sex"]); ?>").prop("checked","checked");//状态
