        ...
        <div>
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-2" id="fubiaoti">
					<a href="<?php echo U('Lens/lensAdd');?>" class="btn btn-xs btn-primary">镜片添加</a>
                </div>
            </div>
            ...
            <input placeholder="请输入关键字" class="btn-sm btn-white" name="keyword" value="<?php echo ($keyword); ?>">
                                        ...
                                        <tbody id="sortable">
                                        	...
                                        	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="grade0 one" name="<?php echo ($v["id"]); ?>" <?php if($action == sort): ?>style="cursor:move;"<?php endif; ?>>
                                              ...
                                              <?php if($action == sort): ?><td id="0_<?php echo ($v["id"]); ?>" class="td_click">
                                                ...
                                                <td style="padding-top:10px;">
                                                <?php if($v["inventory"] < 1): ?><font style="font-weight:bold;color:red">库存不足</font>
                                                <?php else: ?>
                                                  <?php echo ($v["inventory"]); endif; ?>
                                                </td>
                                                ...
                                                <td style="padding-top:10px;">
                                                	<a data-toggle="tooltip" data-placement="top" title="编辑" class="btn btn-sm btn-info" href="<?php echo U('Lens/lensEdit',array('id'=>$v['id']));?>">
                                                  ...
                                                  <?php if($types == 'chose'): ?><a class="btn btn-sm btn-primary add" lens_id="<?php echo ($v["id"]); ?>" name="<?php echo ($v["name"]); ?>" <?php if($lr == 'l'): ?>lr="l"<?php else: ?>lr="r"<?php endif; ?>>
                                                  确认选择
                                                  </a>&nbsp;<?php endif; ?>
